...
function enhanceUI(){
 ...
 if(img){img.src='rot-symbol.svg?v=8';img.removeAttribute('style');img.alt='רו';img.width=92;img.height=42;img.style.cssText='width:92px;height:42px;object-fit:contain;object-position:center;display:block';}
 ...
 // Add sixth metric when the page has only five existing rows.
 ...
 const icons={marketing:'📈',ads:'📣',pr:'📰',sales:'🤝',branding:'◆',product:'🎯'};
 window.__needIcon=icons;
}
